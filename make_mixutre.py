...
def make_eval_dataset(dataset_dir, output_path, speakers=None, echoic=False,
    ...
    Args:
        ...
        echoic (bool): if use echoic environment.
    ...
    wav_file_list = ['300{:0>2}.wav'.format(i) for i in range(1, 36)]
    rir = get_rir(echoic)
    ...
    for speaker0, speaker1 in combinations(speakers, 2):
        ...
        for wav0, wav1 in comb:
            ...
            filename = '{}{}_{}{}_src.wav'.format(speaker0[-3:], wav0[3:5],
                                                  speaker1[-3:], wav1[3:5])
            path = os.path.join(output_path, filename)
            wavfile.write(path, 16000, source)

            filename = '{}{}_{}{}_mix.wav'.format(speaker0[-3:], wav0[3:5],
                                                  speaker1[-3:], wav1[3:5])
            path = os.path.join(output_path, filename)
